            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-8">
                        ...
                        <span className="relative">
                            <span className="bg-gradient-to-r from-teal-500 via-green-500 to-yellow-500 bg-clip-text text-transparent">
                                SniperThink
                            </span>
                            <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-teal-500 via-green-500 to-yellow-500 rounded-full"></div>
                        </span>
                        ?
                    </h1>
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-12 lg:p-16">
                      ...
                      `}>
                                        ...
                                        <div className="absolute inset-0 backface-hidden rotate-y-180">
                                            <div className={`
                        ${capability.bgColor}
                        w-full h-full rounded-2xl p-6 flex flex-col items-center justify-center
                ...
                <div className="text-center mt-20">
                    <div className="inline-flex flex-col sm:flex-row gap-4">
                        <button className="bg-gradient-to-r from-teal-500 to-green-500 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:from-teal-600 hover:to-green-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                            Get Started Today
                        </button>
                        <button className="border-2 border-gray-300 text-gray-700 px-10 py-4 rounded-xl font-semibold text-lg hover:border-teal-500 hover:text-teal-600 transition-all duration-300">
                            Learn More
                        </button>
                    </div>
                </div>
